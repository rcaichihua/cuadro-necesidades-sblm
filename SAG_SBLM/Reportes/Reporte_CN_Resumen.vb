...
Public Class Reporte_CN_Resumen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SAG_SBLM.Reporte_CN_Resumen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_CN_Resumen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_CN_Resumen = New Reporte_CN_Resumen()
        rpt.Site = Me.Site
        Return rpt
    End Function
