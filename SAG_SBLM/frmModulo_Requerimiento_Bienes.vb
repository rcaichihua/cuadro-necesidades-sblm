Public Class frmModulo_Requerimiento_Bienes
    ...
    Private Sub Boton_Salir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Boton_Salir.Click
        Me.Close()
    End Sub
    Private Sub Boton_Nuevo_Requerimiento_Bienes_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Boton_Nuevo_Requerimiento_Bienes.Click
        If Datos.Acceso_Sub_Boton(My.Settings.Usuario.Trim, "Boton_Requerimiento_Bienes", Me.Boton_Nuevo_Requerimiento_Bienes.Name) = True Then
            Dim Formulario As New frmRegistro_Requerimiento_Bienes
    ...
    Sub Llenar(ByVal S_Busqueda As String)
        ...
        If DT.Rows.Count > 0 Then
            ...
            Datos.Evaluacion_Botones_Modulo_Requerimiento_Bienes(My.Settings.Año_Ejecucion, Variable_Numero_Requerimiento_Bien, Boton_Nuevo_Requerimiento_Bienes, Boton_Editar_Requerimiento_Bienes, Boton_Anular_Requerimiento_Bienes, Boton_Eliminar_Requerimiento_Bienes, Boton_Extornar_Requerimiento_Bienes, Boton_Autorizar_Requerimiento_Bienes, Boton_Aprobar_Requerimiento_Bienes, Me.Boton_Visualizar_Requerimiento_Bienes, Me.Boton_Imprimir_Requerimiento_Bienes)
        Else
            Me.lblRegistros.Text = " - Total de Registros Encontrados: 0"
            Me.Boton_Editar_Requerimiento_Bienes.Enabled = False
            Me.Boton_Extornar_Requerimiento_Bienes.Enabled = False
            Me.Boton_Anular_Requerimiento_Bienes.Enabled = False
            Me.Boton_Eliminar_Requerimiento_Bienes.Enabled = False
            Me.Boton_Aprobar_Requerimiento_Bienes.Enabled = False
            Me.Boton_Autorizar_Requerimiento_Bienes.Enabled = False
            Me.Boton_Visualizar_Requerimiento_Bienes.Enabled = False
            Me.Boton_Imprimir_Requerimiento_Bienes.Enabled = False
        End If
    End Sub
        ...
        If Datos.Acceso_Sub_Boton(My.Settings.Usuario.Trim, "Boton_Requerimiento_Bienes", Me.Boton_Visualizar_Requerimiento_Bienes.Name) = True Then
            If Variable_Numero_Requerimiento_Bien.Trim.Length > 0 Then
                If Me.DataGridView1.CurrentCellAddress.Y >= 0 Then
                    Datos.Imprimir_Reporte("Select * From Lista_Detalle_Requerimientos_Bienes_Basica_Reportar Where Año_Ejecucion='" & My.Settings.Año_Ejecucion & "' And Numero='" & Variable_Numero_Requerimiento_Bien & "' Order By Abs(Año_Ejecucion),Abs(Numero)", New Requerimiento_Bienes, 100, "Reporte Requerimiento", False)
                Else
    ...
    Private Sub DataGridView1_CellEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView1.CellEnter
        ...
        End If
    End Sub
    Private Sub Boton_Editar_Requerimiento_Bienes_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Boton_Editar_Requerimiento_Bienes.Click
        If Datos.Acceso_Sub_Boton(My.Settings.Usuario.Trim, "Boton_Requerimiento_Bienes", Me.Boton_Editar_Requerimiento_Bienes.Name) = True Then
            If Variable_Numero_Requerimiento_Bien.Trim.Length > 0 Then
                Dim Formulario As New frmRegistro_Requerimiento_Bienes
    ...
    Private Sub Boton_Actualizar_Registros_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Boton_Actualizar_Registros.Click
        Call Me.Filtrar()
    End Sub
    Private Sub Boton_Imprimir_Requerimiento_Bienes_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Boton_Imprimir_Requerimiento_Bienes.Click
        If Datos.Acceso_Sub_Boton(My.Settings.Usuario.Trim, "Boton_Requerimiento_Bienes", Me.Boton_Imprimir_Requerimiento_Bienes.Name) = True Then
            If Variable_Numero_Requerimiento_Bien.Trim.Length > 0 Then
                If Me.DataGridView1.CurrentCellAddress.Y >= 0 Then
                    Datos.Imprimir_Reporte("Select * From Lista_Detalle_Requerimientos_Bienes_Basica_Reportar Where Año_Ejecucion='" & My.Settings.Año_Ejecucion & "' And Numero='" & Variable_Numero_Requerimiento_Bien & "' Order By Abs(Año_Ejecucion),Abs(Numero)", New Requerimiento_Bienes, 100, "Reporte Requerimiento", True)
                Else
        ...
        End If
    End Sub
    Private Sub Boton_Eliminar_Requerimiento_Bienes_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Boton_Eliminar_Requerimiento_Bienes.Click
        ...
        End If
    End Sub
    Private Sub Boton_Extornar_Requerimiento_Bienes_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Boton_Extornar_Requerimiento_Bienes.Click
        ...
        End If
    End Sub
    Private Sub Boton_Autorizar_Requerimiento_Bienes_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Boton_Autorizar_Requerimiento_Bienes.Click
        If Datos.Acceso_Sub_Boton(My.Settings.Usuario.Trim, "Boton_Requerimiento_Bienes", Me.Boton_Autorizar_Requerimiento_Bienes.Name) = True Then
            If Variable_Numero_Requerimiento_Bien.Trim.Length > 0 Then
                If MessageBox.Show("Deseas realmente Autorizar el Requerimiento seleccionado", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                    Datos.Autorizar_Requerimiento_Bien(My.Settings.Año_Ejecucion, Variable_Numero_Requerimiento_Bien, My.Settings.Usuario)
                End If
                Call Me.Filtrar()
                Call Me.Dimensionar()
                Datos.Evaluacion_Botones_Modulo_Requerimiento_Bienes(My.Settings.Año_Ejecucion, Variable_Numero_Requerimiento_Bien, Boton_Nuevo_Requerimiento_Bienes, Boton_Editar_Requerimiento_Bienes, Boton_Anular_Requerimiento_Bienes, Boton_Eliminar_Requerimiento_Bienes, Boton_Extornar_Requerimiento_Bienes, Boton_Autorizar_Requerimiento_Bienes, Boton_Aprobar_Requerimiento_Bienes, Me.Boton_Visualizar_Requerimiento_Bienes, Me.Boton_Imprimir_Requerimiento_Bienes)
        ...
        End If
    End Sub
    Private Sub Boton_Aprobar_Requerimiento_Bienes_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Boton_Aprobar_Requerimiento_Bienes.Click
        If Datos.Acceso_Sub_Boton(My.Settings.Usuario.Trim, "Boton_Requerimiento_Bienes", Me.Boton_Aprobar_Requerimiento_Bienes.Name) = True Then
            If Variable_Numero_Requerimiento_Bien.Trim.Length > 0 Then
                If MessageBox.Show("Deseas realmente Aprobar el Requerimiento seleccionado", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                    Datos.Aprobar_Requerimiento_Bien(My.Settings.Año_Ejecucion, Variable_Numero_Requerimiento_Bien, My.Settings.Usuario)
                End If
                Call Me.Filtrar()
                Call Me.Dimensionar()
                Datos.Evaluacion_Botones_Modulo_Requerimiento_Bienes(My.Settings.Año_Ejecucion, Variable_Numero_Requerimiento_Bien, Boton_Nuevo_Requerimiento_Bienes, Boton_Editar_Requerimiento_Bienes, Boton_Anular_Requerimiento_Bienes, Boton_Eliminar_Requerimiento_Bienes, Boton_Extornar_Requerimiento_Bienes, Boton_Autorizar_Requerimiento_Bienes, Boton_Aprobar_Requerimiento_Bienes, Me.Boton_Visualizar_Requerimiento_Bienes, Me.Boton_Imprimir_Requerimiento_Bienes)
        ...
        End If
    End Sub
    Private Sub Boton_Anular_Requerimiento_Bienes_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Boton_Anular_Requerimiento_Bienes.Click
        If Datos.Acceso_Sub_Boton(My.Settings.Usuario.Trim, "Boton_Requerimiento_Bienes", Me.Boton_Anular_Requerimiento_Bienes.Name) = True Then
            If Variable_Numero_Requerimiento_Bien.Trim.Length > 0 Then
                If MessageBox.Show("Deseas realmente Anular el Requerimiento seleccionado", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                    Datos.Anular_Requerimiento_Bien(My.Settings.Año_Ejecucion, Variable_Numero_Requerimiento_Bien, My.Settings.Usuario)
                End If
                Call Me.Filtrar()
                Call Me.Dimensionar()
                Datos.Evaluacion_Botones_Modulo_Requerimiento_Bienes(My.Settings.Año_Ejecucion, Variable_Numero_Requerimiento_Bien, Boton_Nuevo_Requerimiento_Bienes, Boton_Editar_Requerimiento_Bienes, Boton_Anular_Requerimiento_Bienes, Boton_Eliminar_Requerimiento_Bienes, Boton_Extornar_Requerimiento_Bienes, Boton_Autorizar_Requerimiento_Bienes, Boton_Aprobar_Requerimiento_Bienes, Me.Boton_Visualizar_Requerimiento_Bienes, Me.Boton_Imprimir_Requerimiento_Bienes)
