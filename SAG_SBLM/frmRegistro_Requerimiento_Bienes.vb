Public Class frmRegistro_Requerimiento_Bienes
    ...
    Private Sub frmRegistro_Requerimiento_Bienes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            Fuente_Financiaminto = Datos.LLenar_Combo_Solo("Select * From Lista_FF Where Año_Ejecucion='" & My.Settings.Año_Ejecucion & "' And Codigo_FF In(2,4)", Me.cbFF, "Fuente")
            Call Me.Dimensionar()
            Datos.Cargar_Requerimiento_Bien_Para_Modificacion(My.Settings.Año_Ejecucion, Variable_Numero_Requerimiento_Bien, Me.dgvRequerimientoBienes, Me.cbUnidadOrganica, Me.txtJustificacion)
            Call Me.Total()
            Separador = Application.CurrentCulture.NumberFormat.NumberDecimalSeparator
        End If
    End Sub
    ...
    Private Sub Dimensionar()
        ...
        Me.dgvRequerimientoBienes.Columns.Add("Clasificador", "Clasificador")
        Me.dgvRequerimientoBienes.Columns.Add("Meta", "Meta")
        ...
        Me.dgvRequerimientoBienes.Columns.Add("Codigo", "Codigo")
        ...
        Me.dgvRequerimientoBienes.Columns.Add("Costo", "Costo")
        Me.dgvRequerimientoBienes.Columns.Add("Cadena", "Cadena") '23
        ...
        Me.dgvRequerimientoBienes.Columns(17).Width = 110
        ...
        Me.dgvRequerimientoBienes.Columns(23).Visible = False
        ...
        dgvRequerimientoBienes.Columns(24).Width = 100
        ...
        dgvRequerimientoBienes.Columns(25).Width = 100
        ...
        dgvRequerimientoBienes.Columns(26).Width = 100
    End Sub
        ...
        If Editar = False Then
            If Me.dgvRequerimientoBienes.RowCount > 0 Then
                If Me.txtJustificacion.Text.Trim.Length > 0 Then
                    ...
                    Datos.Nuevo_Requerimiento_Bienes(My.Settings.Año_Ejecucion, Numero, Unidad_Organica.Rows(Me.cbUnidadOrganica.SelectedIndex).Item("Codigo_Unidad_Organica").ToString, Me.txtJustificacion.Text.Trim, Today.Date, My.Settings.Usuario, "01", Me.Total)

                    For Recorrido As Integer = 0 To Me.dgvRequerimientoBienes.RowCount - 1
                        Datos.Nuevo_Detalle_Requerimiento_Bienes(My.Settings.Año_Ejecucion, Numero, Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(1).Value, Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(2).Value, Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(3).Value, Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(4).Value, Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(5).Value, Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(6).Value, Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(7).Value, Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(8).Value, Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(10).Value, Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(11).Value, Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(12).Value, "01", Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(13).Value, Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(14).Value, Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(15).Value, Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(16).Value, Convert.ToDouble(Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(21).Value), Convert.ToDouble(Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(22).Value))
                    Next
                    Me.Close()
                Else
        ...
        Else
            If Me.dgvRequerimientoBienes.RowCount > 0 Then
                If Me.txtJustificacion.Text.Trim.Length > 0 Then
                    ...
                    For Recorrido As Integer = 0 To Me.dgvRequerimientoBienes.RowCount - 1
                        Datos.Nuevo_Detalle_Requerimiento_Bienes(My.Settings.Año_Ejecucion, Variable_Numero_Requerimiento_Bien, Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(1).Value, Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(2).Value, Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(3).Value, Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(4).Value, Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(5).Value, Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(6).Value, Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(7).Value, Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(8).Value, Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(10).Value, Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(11).Value, Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(12).Value, "01", Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(13).Value, Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(14).Value, Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(15).Value, Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(16).Value, Convert.ToDouble(Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(21).Value), Convert.ToDouble(Me.dgvRequerimientoBienes.Rows(Recorrido).Cells(22).Value))
                    Next
    ...
    Private Sub Evalua_Saldo_del_Mes()
        Try
            Me.txtSaldoMes.Text = Format(Datos.Evalua_Saldo_del_Mes(Obtiene_Mes_Actual(),
                                                                    Convert.ToDouble(Fuente_Financiaminto.Rows(Me.cbFF.SelectedIndex).Item("Codigo_FF").ToString), 
