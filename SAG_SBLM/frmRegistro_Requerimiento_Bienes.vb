Public Class frmRegistro_Requerimiento_Bienes
    ...
    Private Sub frmRegistro_Requerimiento_Bienes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            Fuente_Financiaminto = Datos.LLenar_Combo_Solo("Select * From Lista_FF Where Año_Ejecucion='" & My.Settings.Año_Ejecucion & "' And Codigo_FF In(2,4)", Me.cbFF, "Fuente")
            Call Me.Dimensionar()
            Datos.Cargar_Requerimiento_Bien_Para_Modificacion(My.Settings.Año_Ejecucion, Variable_Numero_Requerimiento_Bien, Me.DataGridView1, Me.cbUnidadOrganica, Me.txtJustificacion)
            Call Me.Total()
            Separador = Application.CurrentCulture.NumberFormat.NumberDecimalSeparator
        End If
    End Sub
    ...
    Private Sub Dimensionar()
        ...
        Me.DataGridView1.Columns.Add("CA", "CA") '12
        ...
        Me.DataGridView1.Columns.Add("Unidad", "Unidad") '20
        Me.DataGridView1.Columns.Add("Cantidad", "Cantidad")
        Me.DataGridView1.Columns.Add("Costo", "Costo")
        Me.DataGridView1.Columns.Add("Cadena", "Cadena") '23
    ...
    Private Sub DataGridView1_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        ...
        If DataGridView1.Columns(e.ColumnIndex).Name = "btnEditar" Then
            ...
            Datos.Mostrar_Data_Item_Catalogo(Me.DataGridView1.CurrentRow.Cells(13).Value, Me.DataGridView1.CurrentRow.Cells(14).Value, Me.DataGridView1.CurrentRow.Cells(15).Value, Me.DataGridView1.CurrentRow.Cells(16).Value, 1, Me.txtCodigoGrupo, Me.txtGrupo, Me.txtCodigoClase, Me.txtClase, Me.txtCodigoFamilia, Me.txtFamilia, Me.txtCodigoItem, Me.txtItem, Me.txtCodigoUnidadMedida, Me.txtUnidadMedida, Me.txtTipoTransaccion, Me.txtGenerica, Me.txtSubGenerica, Me.txtSubGenericaDetalle, Me.txtEspecifica, Me.txtEspecificaDetalle)
            Me.DataGridView1.Rows.Remove(Me.DataGridView1.CurrentRow)
            If Me.DataGridView1.Rows.Count = 0 Then Me.cbUnidadOrganica.Enabled = True Else Me.cbUnidadOrganica.Enabled = False
            Call Me.Evaluar_Saldos()
        End If
            ...
            If Me.DataGridView1.RowCount > 0 Then
                If Me.txtJustificacion.Text.Trim.Length > 0 Then
                    ...
                    For Recorrido As Integer = 0 To Me.DataGridView1.RowCount - 1
                        Datos.Nuevo_Detalle_Requerimiento_Bienes(My.Settings.Año_Ejecucion, Numero, Me.DataGridView1.Rows(Recorrido).Cells(1).Value, Me.DataGridView1.Rows(Recorrido).Cells(2).Value, Me.DataGridView1.Rows(Recorrido).Cells(3).Value, Me.DataGridView1.Rows(Recorrido).Cells(4).Value, Me.DataGridView1.Rows(Recorrido).Cells(5).Value, Me.DataGridView1.Rows(Recorrido).Cells(6).Value, Me.DataGridView1.Rows(Recorrido).Cells(7).Value, Me.DataGridView1.Rows(Recorrido).Cells(8).Value, Me.DataGridView1.Rows(Recorrido).Cells(10).Value, Me.DataGridView1.Rows(Recorrido).Cells(11).Value, Me.DataGridView1.Rows(Recorrido).Cells(12).Value, "01", Me.DataGridView1.Rows(Recorrido).Cells(13).Value, Me.DataGridView1.Rows(Recorrido).Cells(14).Value, Me.DataGridView1.Rows(Recorrido).Cells(15).Value, Me.DataGridView1.Rows(Recorrido).Cells(16).Value, Convert.ToDouble(Me.DataGridView1.Rows(Recorrido).Cells(21).Value), Convert.ToDouble(Me.DataGridView1.Rows(Recorrido).Cells(22).Value))
                    Next
                    Me.Close()
                Else
        ...
        Else
            If Me.DataGridView1.RowCount > 0 Then
                If Me.txtJustificacion.Text.Trim.Length > 0 Then
                    ...
                    For Recorrido As Integer = 0 To Me.DataGridView1.RowCount - 1
                        Datos.Nuevo_Detalle_Requerimiento_Bienes(My.Settings.Año_Ejecucion, Variable_Numero_Requerimiento_Bien, Me.DataGridView1.Rows(Recorrido).Cells(1).Value, Me.DataGridView1.Rows(Recorrido).Cells(2).Value, Me.DataGridView1.Rows(Recorrido).Cells(3).Value, Me.DataGridView1.Rows(Recorrido).Cells(4).Value, Me.DataGridView1.Rows(Recorrido).Cells(5).Value, Me.DataGridView1.Rows(Recorrido).Cells(6).Value, Me.DataGridView1.Rows(Recorrido).Cells(7).Value, Me.DataGridView1.Rows(Recorrido).Cells(8).Value, Me.DataGridView1.Rows(Recorrido).Cells(10).Value, Me.DataGridView1.Rows(Recorrido).Cells(11).Value, Me.DataGridView1.Rows(Recorrido).Cells(12).Value, "01", Me.DataGridView1.Rows(Recorrido).Cells(13).Value, Me.DataGridView1.Rows(Recorrido).Cells(14).Value, Me.DataGridView1.Rows(Recorrido).Cells(15).Value, Me.DataGridView1.Rows(Recorrido).Cells(16).Value, Convert.ToDouble(Me.DataGridView1.Rows(Recorrido).Cells(21).Value), Convert.ToDouble(Me.DataGridView1.Rows(Recorrido).Cells(22).Value))
                    Next
